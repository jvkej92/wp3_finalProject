...
<div class="container mt-4 pt-4">
    ...
    <div id="paypal-form" class="collapse multi-collapse bg-light shadow p-4 justify-content-center">       
            <h2 class="card-header pb-4">Continue Checkout With:</h2>
            <div id="paypal-container" class="p-4 m-auto"> </div>
    </div>
     
    <div id="credit-card-form" class="collapse multi-collapse show bg-light p-4 shadow">
    <form id="form" method="POST" action="{{ url('/subscribe/process/payment') }}">
    @csrf
        <div class="row justify-content-around mt-4">
            <div class="col-6">
                <h2>Billing Info</h2>
                <input id="nonce" type="hidden" name="nonce" value="">
                <input id="slug" type="hidden" name="slug" value="{{$plans['slug']}}">
            ...
            <div class="col-6">
                ...
                <div class="row justify-content-end mb-2">
                    <h3 class="total">${{$plans['cost']}}0</h3>
                </div>
                <hr class="my-4"/>
                <button id="pay-submit" class="submit btn btn-primary btn-block">Submit</button>
            </div>
        </div>
    </form>
</div>
