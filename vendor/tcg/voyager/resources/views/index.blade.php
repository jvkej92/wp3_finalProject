...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6" style="position: relative; height: 7vh;">
                <h2 class="text-center mb-4">Total Users</h2>
                <canvas id="totalUsers"></canvas>
                <h3 class="text-center">Total Users: <span id="total"></span></h3>
                
            </div>
            <div class="col-md-6" style="position: relative; height: 7vh;">
                <h2 class="text-center mb-4">New Users</h2>
                <canvas id="newUsers"></canvas>
                <h3 class="text-center">New Users: <span id="totalNew"></span></h3>
            </div>
        </div>
    </div>
...
<script>
        ...
        fetch('/userMetrics/totalUsers/4').then(response => response.json()).then(response => {
            document.getElementById('total').innerHTML = response[3];
            var totalUsersChart = new Chart(totalUsers, {
                        type: 'line',
                        data: {
                            labels: ["120 Days Ago", "90 Days Ago", "Last Month", "This Month"],
                            datasets: [{
                                label: 'New Users',
                                data: response,
                                backgroundColor: [
        ...
        fetch('/userMetrics/newUsers/4').then(response => response.json()).then(response => {
            document.getElementById('totalNew').innerHTML = response[3];
            var newUsersChart = new Chart(newUsers, {
                        type: 'bar',
                        data: {
                            labels: ["120 Days Ago", "90 Days Ago", "Last Month", "This Month"],
                            datasets: [{
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        //Default google analytics charts
        {{--  <script>
            // View Selector 2 JS
